...
addInstanceFleet = Request.request service method  where
    service = Request.ServiceName "EMR"
    method = Request.MethodName "addInstanceFleet"
...
addInstanceGroups = Request.request service method  where
    service = Request.ServiceName "EMR"
    method = Request.MethodName "addInstanceGroups"
...
addJobFlowSteps = Request.request service method  where
    service = Request.ServiceName "EMR"
    method = Request.MethodName "addJobFlowSteps"
...
cancelSteps = Request.request service method  where
    service = Request.ServiceName "EMR"
    method = Request.MethodName "cancelSteps"
...
createSecurityConfiguration = Request.request service method  where
    service = Request.ServiceName "EMR"
    method = Request.MethodName "createSecurityConfiguration"
...
deleteSecurityConfiguration = Request.request service method  where
    service = Request.ServiceName "EMR"
    method = Request.MethodName "deleteSecurityConfiguration"
...
describeJobFlows = Request.request service method  where
    service = Request.ServiceName "EMR"
    method = Request.MethodName "describeJobFlows"
...
describeSecurityConfiguration = Request.request service method  where
    service = Request.ServiceName "EMR"
    method = Request.MethodName "describeSecurityConfiguration"
...
describeStep = Request.request service method  where
    service = Request.ServiceName "EMR"
    method = Request.MethodName "describeStep"
...
listBootstrapActions = Request.request service method  where
    service = Request.ServiceName "EMR"
    method = Request.MethodName "listBootstrapActions"
...
listInstanceFleets = Request.request service method  where
    service = Request.ServiceName "EMR"
    method = Request.MethodName "listInstanceFleets"
...
listInstanceGroups = Request.request service method  where
    service = Request.ServiceName "EMR"
    method = Request.MethodName "listInstanceGroups"
...
listInstances = Request.request service method  where
    service = Request.ServiceName "EMR"
    method = Request.MethodName "listInstances"
...
listSecurityConfigurations = Request.request service method  where
    service = Request.ServiceName "EMR"
    method = Request.MethodName "listSecurityConfigurations"
...
listSteps = Request.request service method  where
    service = Request.ServiceName "EMR"
    method = Request.MethodName "listSteps"
...
modifyInstanceFleet = Request.request service method  where
    service = Request.ServiceName "EMR"
    method = Request.MethodName "modifyInstanceFleet"
...
modifyInstanceGroups = Request.request service method  where
    service = Request.ServiceName "EMR"
    method = Request.MethodName "modifyInstanceGroups"
...
putAutoScalingPolicy = Request.request service method  where
    service = Request.ServiceName "EMR"
    method = Request.MethodName "putAutoScalingPolicy"
...
removeAutoScalingPolicy = Request.request service method  where
    service = Request.ServiceName "EMR"
    method = Request.MethodName "removeAutoScalingPolicy"
...
runJobFlow = Request.request service method  where
    service = Request.ServiceName "EMR"
    method = Request.MethodName "runJobFlow"
...
setTerminationProtection = Request.request service method  where
    service = Request.ServiceName "EMR"
    method = Request.MethodName "setTerminationProtection"
...
setVisibleToAllUsers = Request.request service method  where
    service = Request.ServiceName "EMR"
    method = Request.MethodName "setVisibleToAllUsers"
...
terminateJobFlows = Request.request service method  where
    service = Request.ServiceName "EMR"
    method = Request.MethodName "terminateJobFlows"
